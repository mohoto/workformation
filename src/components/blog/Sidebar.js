    ...
    return (
        <div className="space-y-6">
            <div className="p-6 bg-white rounded-md shadow-md">
                <h3 className="relative mb-8 text-lg font-semibold before:content-[''] before:w-[50px] before:h-[4px] before:bottom-[-10px] before:left-[0] before:absolute before:rounded-lg before:bg-second-50">Les autres articles:</h3>
                <ul className="space-y-2">
                    {articles && articles.filter(article => article.slug !== slug).map(article => (
                    <li key={article.id} className="pb-2 mb-2 border-b last:border-none last:mb-0 last:pb-0">
