                    ...
                    <div className={`relative transition duration-100 ease-out ${formState && 'transform scale-1'}`}>
                        <div>
                            <div className={`transition duration-100 ease-out ${formState && 'transform scale-0'}`}>
                                <div>
                                    <p className="mb-2 font-light tracking-wide text-center text-gray-200">Demandez à être appelé par un de nos conseillers.</p>
                                </div>
                                {errorMessage &&
                ...
                {formState && (
                    <div className="flex items-center justify-center mt-8 mb-12">
                        ...
                        <div className="px-4">
                            ...
                            <div className="mt-6">
                                <h4 className="text-lg font-semibold tracking-wide text-center text-white">Votre demande a été enregistrée</h4>
                                <p className="mt-4 tracking-wide text-center text-white">Un de nos conseillers vous rappelera dans les plus brefs délais.</p>
                            </div>
                        </div>
                        )}
                    </div> 
