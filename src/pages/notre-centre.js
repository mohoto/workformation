                    ...
                    <div>
                        <div className="flex flex-col justify-center mt-8 md:mt-20 md:flex-row md:items-center">
                            <div className="flex justify-center flex-1 mb-6 md:mb-0">
                                <div className="relative overflow-hidden rounded-lg w-80 h-80">
                                    ...
                                    fill
                                    className="object-contain transition duration-500 ease-in-out transform rounded-lg cursor-pointer hover:scale-110"
                        ...
                        <div className="flex flex-col mt-20 md:flex-row md:items-center">
                            ...
                            <div className="flex-1 md:order-1">
                                <h2 className="mb-4 text-xl font-semibold text-second-50">Des formations pour développer les compétences professionnelles</h2>
                        ...
                        <div className="flex flex-col mt-20 md:flex-row md:items-center">
                            ...
                            <div className="flex-1">
                                <h2 className="mb-4 text-xl font-semibold text-second-50">Des formations orientées métier</h2>
                        ...
                        <div className="flex flex-col mt-20 md:flex-row md:items-center">
                            ...
                            <div className="flex-1 md:order-1">
                                <h2 className="mb-4 text-xl font-semibold text-second-50">Des formateurs qualifiés</h2>
                        ...
                        <div className="flex flex-col mt-20 md:flex-row md:items-center">
                            ...
                            <div className="flex-1">
                                <h2 className="mb-4 text-xl font-semibold text-second-50">Des équipements modernes pour une formation de qualité</h2>
